...
import { LogOut, User, Shield, ChevronDown, LayoutDashboard } from 'lucide-react';
...
export default function UserMenu() {
  ...
  return (
    <Link
      href="/login"
      className="text-lab-gray-400 hover:text-lab-white transition-colors opacity-30 hover:opacity-100"
