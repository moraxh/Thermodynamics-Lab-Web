    ...
    <section id="publications" className="py-24 bg-lab-black relative">
      ...
      {loading ? (
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-lab-white mb-3">¡Nada por aquí todavía!</h3>
          <p className="text-lab-gray-400 text-center max-w-md">
            Parece que las publicaciones están en proceso de revisión por pares.
            <br />
            <span className="text-lab-blue">O tal vez están en otra dimensión temporal... ⏰📚</span>
          </p>
        </motion.div>
      ) : (
